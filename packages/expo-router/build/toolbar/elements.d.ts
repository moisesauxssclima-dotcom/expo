...
export interface ToolbarButtonProps {
     ...
     *
     * ...
     * <Toolbar.Button>As text passed as children</Toolbar.Button>
     * <Toolbar.Button icon="star.fill" />
     * ```
     *
 ...
 * @platform ios
 */
export declare const ToolbarView: ({ children, style, separateBackground, hidden, hidesSharedBackground, }: ToolbarViewProps) => import("react").JSX.Element;
